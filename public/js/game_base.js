var offset = window.innerHeight*0.8; // 調整軌道高度
...
// 建立其中bt白音符
var bt_geometry = new THREE.BoxGeometry(0.15, 0.01, 0.025);
...
// 建立其中fx黃音符
var fx_geometry = new THREE.BoxGeometry(0.313, 0.01, 0.025);
...
fx1_cube.scale.z = 80.51;
fx1_cube.position.z = 2;
fx2_cube.position.z = 2;
